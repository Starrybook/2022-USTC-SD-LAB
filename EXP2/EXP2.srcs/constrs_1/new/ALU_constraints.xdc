...
create_clock -add -name sys_clk_pin -period 2.730 -waveform {0 1} [get_ports {clk}];
...
set_property -dict { PACKAGE_PIN V11   IOSTANDARD LVCMOS33 } [get_ports { co }]; #IO_L21N_T3_DQS_A06_D22_14 Sch=led[15]
...
set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { ci }]; #IO_L4N_T0_D05_14 Sch=btnu
